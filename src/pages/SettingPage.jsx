...
const projects = [
  ...
  },
  {
    ...
    icon: Atom,
    badgeColor: "bg-indigo-100 text-indigo-800 border-indigo-300 dark:bg-indigo-950/80 dark:text-indigo-300 dark:border-indigo-800",
  },
  {
    id: 5,
...
export default function SettingPage() {
  return (
    <div className="bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100 min-h-screen py-12 transition-colors duration-300">
      <section className="body-font">
        <div className="container px-5 py-12 mx-auto">
          
          {/* Заголовок */}
          <div className="flex flex-col text-center w-full mb-16">
            <span className="text-xs uppercase tracking-widest font-bold text-indigo-600 dark:text-indigo-400 mb-2">
              Портфолио
            </span>
            <h1 className="sm:text-4xl text-3xl font-extrabold title-font mb-4 text-slate-900 dark:text-white">
              Мой путь во Frontend-разработке
            </h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-600 dark:text-slate-400">
              Проекты и технологии, которые я освоил во время обучения в{" "}
              <span className="font-bold text-emerald-600 dark:text-emerald-400">Alif Academy</span>. Разрабатываю современные, быстрые и удобные веб-приложения.
            </p>
          </div>
            ...
            {projects.map((item) => {
              ...
              return (
                <div key={item.id} className="lg:w-1/3 sm:w-1/2 p-4">
                  <div className="group relative h-72 rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                    ...
                    <div className="px-6 py-6 relative z-10 w-full h-full bg-white/95 dark:bg-slate-900/95 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-center">
                      ...
                      <h1 className="title-font text-xl font-bold text-slate-900 dark:text-white mb-2">
                        {item.title}
                      </h1>
                      <p className="leading-relaxed text-sm text-gray-600 dark:text-slate-300 font-normal">
                        {item.description}
                      </p>
                    </div>
